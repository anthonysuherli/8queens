"""Explore route — the research pipeline over SSE, mirroring `qwen8_explore`.
...
The pipeline + persistence sequence mirrors ``mcp/server.py::qwen8_explore``
...
async def _run_and_persist(
    ...
    """Pipeline + persistence, mirroring ``mcp/server.py::qwen8_explore``."""

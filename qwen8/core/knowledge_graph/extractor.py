...
from qwen8.core.config import KnowledgeGraphConfig
from qwen8.core.knowledge_graph.models import KGExtraction
...
def backfill_grounding(extraction: KGExtraction, findings: list[dict]) -> int:
    ...
    Ported from qwen8. The generic-name guard prevents a vague label from matching

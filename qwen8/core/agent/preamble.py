...
from qwen8.core.agent.synopsis import load_synopsis
from qwen8.core.clients.embeddings import embed_text
from qwen8.core.config import TiersConfig, get_config

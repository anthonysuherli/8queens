...
from queens8.core.config import KnowledgeGraphConfig
from queens8.core.knowledge_graph.models import KGExtraction
...
def backfill_grounding(extraction: KGExtraction, findings: list[dict]) -> int:
    ...
    Ported from queens8. The generic-name guard prevents a vague label from matching

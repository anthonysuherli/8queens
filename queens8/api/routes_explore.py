"""Explore route — the research pipeline over SSE, mirroring `queens8_explore`.
...
The pipeline + persistence sequence mirrors ``mcp/server.py::queens8_explore``
...
from queens8.api.deps import resolve_kb_or_404
from queens8.core.agent.state import TenantContext
from queens8.core.agent.synopsis import maybe_rebuild_synopsis
from queens8.core.clients.embeddings import embed_batch
...
from queens8.store import Store
...
async def _run_and_persist(
    ...
    """Pipeline + persistence, mirroring ``mcp/server.py::queens8_explore``."""
